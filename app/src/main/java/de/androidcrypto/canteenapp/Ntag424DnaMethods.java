...
public class Ntag424DnaMethods {
    ...
    public static final byte STANDARD_FILE_NUMBER_01 = (byte) 0x01; // 32 bytes
    public static final byte STANDARD_FILE_NUMBER_02 = (byte) 0x02; // 256 bytes
    public static final byte STANDARD_FILE_NUMBER_03 = (byte) 0x03; // 128 bytes
 ...
 */
     ...
     * @param offset
     * @param length
     * @param testMode on 'true' there is no transmission but only comparing step results with
